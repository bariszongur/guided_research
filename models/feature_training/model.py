...
class Block(nn.Module):
    ...
    """
    Upsampling block that is used in FeatureExtractor.
    """
...
class FeatureExtractor(nn.Module):
    """
    Reconstruction loss based Fine-tuner for the DINO model. Used 3 upsamling blocks to match the original image.
    ...
    def __init__(self, args):
        ...
        self.last_layer = nn.Sequential(
            nn.Conv2d(in_channels=self.f_args["channels"]//4, out_channels=3, kernel_size=1, stride=1)
            #nn.Sigmoid()
        )
